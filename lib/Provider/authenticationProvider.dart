...
import 'package:eshop_multivendor/Provider/otp_validate.dart';
...
class AuthenticationProvider extends ChangeNotifier {
  ...
  // value for parameter
  String? mobilennumberPara, passwordPara,emailpara,otppara;
  ...
  get mobilenumbervalue => mobilennumberPara;
   get emailparavalue => emailpara;
   get otpparavalue=>otppara;
  ...
  //get System Policies
  Future<Map<String, dynamic>> getLoginotpData() async {
    log('loggggggg');
    try {
      var parameter = {EMAIL: 'kalyan@gmail.com',OTP:otppara};
      var result = await AuthRepository.fetchLoginOtp(parameter: parameter);
